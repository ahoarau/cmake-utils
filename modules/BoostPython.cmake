# xxx_boostpy_add_module(name [sources...])
function(xxx_boostpy_add_module name)
    python_add_library(${name} MODULE WITH_SOABI ${ARGN})
    target_link_libraries(${name} PRIVATE Boost::python)
endfunction()

# xxx_boostpy_add_stubs(stubs_target_name MODULE module_name PYTHON_PATH path DEPENDS target [VERBOSE])
function(xxx_boostpy_add_stubs name)
    set(options VERBOSE)
